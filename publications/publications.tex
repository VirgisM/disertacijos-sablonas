...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Styling of author's papers list. Please do not change it.
\makeatletter
...
\textbf{Articles in CA WoS journals/Straipsniai CA WoS žurnaluose:}

\begin{publicationlist}{}
    \publicationentry{A}{Pavardė, V. \& Kitas, A. Title of the book - knygos pavadinimas. (CRC Press,2024)}
    \publicationentry{A}{lorem ipsum dwa}
    \publicationentry{A}{lorem ipsum tri}
\end{publicationlist}

\textbf{Other publications/kitos publikacijos:}
\begin{publicationlist}{}
    \publicationentry{B}{Pavardė, V. \& Kitas, A. Title of the paper - straipsnio pavadinimas. {\em Biochimica Et Biophysica Acta (BBA)-Biomembranes}. \textbf{1061}, 33-38 (2024), https://www.mii.lt}
    \publicationentry{B}{lorem ipsum dwa}
    \publicationentry{B}{lorem ipsum tri}
\end{publicationlist}


% Citation examples for the dissertation texts
\ref{mypaper:A.1}
\ref{mypaper:A.3}
\ref{mypaper:B.2}