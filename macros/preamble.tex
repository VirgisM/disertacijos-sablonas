...
\captionsetup[figure]{labelsep=period} %  change default : to "."
...
% Spacing for TOC titles
\setlength{\cftaftertoctitleskip}{13.5pt}
\setlength{\cftafterlottitleskip}{13.5pt}
\setlength{\cftafterloftitleskip}{13.5pt}
\setlength{\cftbeforetoctitleskip}{-10mm} %Fix spacing of Table of contents to meet VU standard
...
\makeglossaries                                                      % Inicialize all glossaries

% Defining style for acronyms and abbreviations also for symbols glossaries printing
...
% Defining main glossary printing
\newglossarystyle{gls-style}{%
    \setglossarystyle{list}% Default style
    % \baselineskip=0mm
    \renewcommand*{\glossaryheader}{}%
    \renewcommand*{\glossentry}[2]{%
        \item[\glsentryitem{##1}%
        \glstarget{##1}{\Glossentryname{##1}}]  % make first letter of word in uppercase
        -- \glossentrydesc{##1}\glspostdescription\space ##2 % add long - at the start of the description
    }%
